...
export function SignUp() {
    ...
    async function handleCadastro(e: React.FormEvent) {
        ...
        try {
            ...
            const mensagemError = err.response?.data?.mensagem;
            alert(mensagemError || "Erro ao realizar cadastro");
        }
    }
                        ...
                        <Grid size={5} className='signup-form form'>
                            ...
                            <Box component="form" onSubmit={handleCadastro} sx={{ '& .MuiTextField-root': { width: '100%' } }} noValidate autoComplete="off">
                                <TextField
                                    ...
                                    error={errors.nome}
                                    helperText={errors.nome ? "Preencha o Nome" : ""}
                                />
                                <TextField
                                    label="E-mail"
                                    type="email"
                                    ...
                                    error={errors.email}
                                    helperText={errors.email ? "Preencha o E-mail" : ""}
                                />
                                <TextField
                                    label="Senha"
                                    type="password"
                                    ...
                                    error={errors.senha}
                                    helperText={errors.senha ? "Preencha a Senha" : ""}
                                />
                                <TextField
                                    label="Usuário"
                                    variant="outlined"
                                    ...
                                    helperText={errors.username ? "Preencha o Usuário" : ""}
                                />
                                <Button type="submit" variant="contained" disableElevation>Cadastrar</Button>
                            </Box>
